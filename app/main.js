...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.like-button').on('click', function() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('like-button_active');
});
